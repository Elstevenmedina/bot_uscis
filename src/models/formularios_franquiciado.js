...
const formularios_franquicia = new Schema({
  Titulo: { type: String, require: true },
  FechaCreacion: { type: String, require: true },
  _idFranquiciado: { type: String, require: true },
...
module.exports = mongoose.model("formularios_franquicia", formularios_franquicia);
